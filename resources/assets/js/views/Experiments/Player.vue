<template>
    <default-layout>
                ...
                <div class="inner">
                    <div class="card-wrapper">
                        ...
                        <div class="box-snapshot">
                            ...
                            <img :src="'/spotify_image/' + meta.imageSrc" v-on:load="trackImageChanged" v-else/>
                        </div>
        ...
        <div class="connect-spotify" v-else>
            <p>To use the web player please connect to Spotify.</p>
            <a :href="authUrl" class="spotify-button">Connect to Spotify</a>
        </div>
    </default-layout>
</template>
...
<script>
  ...
  export default {
    ...
    beforeMount() {
      this.addScript('/js/color-thief.min.js').then(() => {
    ...
    methods: {
      ...
      async fetchToken() {
        return new Promise(async (resolve) => {
          axios.get('/spotify_token').then((r) => {
            if (r.data.hasOwnProperty('authUrl')) {
              this.authUrl = r.data.authUrl;
            } else {
              this.spotify_token = r.data.token;
