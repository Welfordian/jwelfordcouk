...
toolbox.router.get(/^https:\/\/jwelford.dev\//, toolbox.cacheFirst);
toolbox.router.get(/^https:\/\/jwelford.co.uk\/api\//, toolbox.networkFirst);
toolbox.router.get(/^https:\/\/jwelford.dev\/api\//, toolbox.networkFirst);